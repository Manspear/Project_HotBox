...
public:
	...
	void fProcessMessage(char* messageData, MessageType& msgType, bool& isDeleted);
	...
	void fProcessMesh(char* messageData, unsigned int meshCount, bool& isDeleted);
	...
	void fProcessMaterial(char* messageData, bool& isDeleted);
	...
	void fProcessCamera(char* messageData, unsigned int cameraCount, bool& isDeleted);
